...
if __name__ == "__main__":
    ...
    parser.add_argument("-na", "--no-audio", dest="no_audio", action="store_true", default=False, required=False, help="Pass this to send no audio data")
    parser.add_argument("-nb", "--no-blendshape", dest="no_anime", action="store_true", default=False, required=False, help="Pass this to send no blendshape data")
